                    ...
                    <div class="col-md-12">
                        <form action="{{ route('measurement.store') }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <select name="clients_id" id="clients_id" class="form-control" style="height: 40px; border: 1px solid #ced4da; border-radius: 5px; width: 200px;" required>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group input-group-outline">
                                        <input type="date" name="date" id="date" class="form-control" style="height: 40px; border: 1px solid #ced4da; border-radius: 5px; width: 200px;" value="{{ old('date', $measurement->date) }}">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-outline">
                                    <select name="categories_id" id="categories_id" class="form-control" style="height: 40px; border: 1px solid #ced4da; border-radius: 5px; width: 200px;" required>
