<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='Manage Clients'></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="row gx-4 mb-2">
                    ...
                    <div class="container">
                        ...
                        <div class="container">
                            <h2 class="text-center mb-4">Manage Client</h2>
                                ...
                                <div class="col-md-8">
                                        ...
                                        <form action="{{ route('client.update', $client->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="mobile" name="mobile" class="form-control" value="{{ $client->mobile }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="reffering">Referring:</label>
                                                <input type="text" id="reffering" name="reffering" class="form-control" value="{{ $client->reffering }}" required>
                                            </div>

                                            <div class="form-group">
                                                <label for="address">Address:</label>
                                                <textarea id="address" name="address" class="form-control" required>{{ $client->address }}</textarea>
                                            </div>
