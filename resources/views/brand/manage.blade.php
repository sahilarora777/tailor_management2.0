<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <div class="main-content position-relative bg-gray-100 max-height-vh-100 h-100">
        <!-- Navbar -->
        <x-navbars.navs.auth titlePage='Manage brands'></x-navbars.navs.auth>
        <!-- End Navbar -->
            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="row gx-4 mb-2">
                    ...
                    <div class="container">
                        ...
                        <div class="container">
                            <h2 class="text-center mb-4">Manage brand</h2>
                                        ...
                                        <form action="{{ route('brand.update', $brand->id) }}" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select id="status" name="status" class="form-control" required>
                                                    <option value="available" {{ $brand->status === 'available' ? 'selected' : '' }}>Available</option>
                                                    <option value="not available" {{ $brand->status === ' not available' ? 'selected' : '' }}>Not Available</option>
                                                </select>
                                            </div>
